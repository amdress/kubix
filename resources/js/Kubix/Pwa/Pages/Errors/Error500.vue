<template>
  <div class="min-h-screen bg-[#080a11] flex flex-col items-center justify-center p-6 font-sans">
    ...
    <div class="mb-8 relative">
      ...
      <div class="relative inline-flex items-center justify-center p-8 bg-purple-500/10 border border-purple-500/20 rounded-full shadow-2xl">
        <i class="fa-solid fa-bug text-6xl text-purple-500"></i>
      </div>
    </div>

    <div class="text-center max-w-md">
      <h1 class="text-6xl font-black text-white tracking-tighter mb-2">500</h1>
      <h2 class="text-xl font-bold text-white uppercase tracking-[0.3em] mb-4">Erro Interno</h2>
      <p class="text-gray-500 text-sm leading-relaxed mb-8">
        Ocorreu um erro inesperado no servidor.
        Nossa equipe já foi notificada, você pode retornar ao painel principal do <span class="text-indigo-500 font-bold">KUBIX SYS</span>.
      </p>
    </div>
    ...
    <div class="mt-16 opacity-20">
      <h3 class="text-[10px] font-black text-gray-400 uppercase tracking-[0.5em]">System Stability Protocol Active</h3>
    </div>
  </div>
</template>
